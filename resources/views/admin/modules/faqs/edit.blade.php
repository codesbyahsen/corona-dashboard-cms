                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="dropdown-select-single" name="faq_category_id" id="faq-category"
                                            ...
                                            @foreach ($faqCategories as $faqCategory)
                                                <option value="{{ $faqCategory?->id }}" @selected(old('faq_category_id', $faq?->faqCategory?->id) == $faqCategory?->id)>
                                                    {{ $faqCategory?->name ?? '' }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row pt-2">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="answer" id="summernote" rows="4">{!! old('answer', $faq?->answer ?? '') !!}</textarea>
                                        @error('answer')
                                            <span class="text-danger small">{{ $message }}</span>
                                        @enderror
                                    </div>
