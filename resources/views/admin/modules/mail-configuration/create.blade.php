                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mailTransport"
                            ...
                            <div class="row pt-2">
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mailPort"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        <label for="mailEncryption">Mail Encryption <span class="text-danger">*</span></label>
                            ...
                            <div class="row pt-2">
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="mailFrom"
